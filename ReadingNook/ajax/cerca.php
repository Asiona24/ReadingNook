...
if ((isset($_POST['s'])) and ($_POST['s']!= "")) {
	...
	while($line=pg_fetch_array($result1,null,PGSQL_ASSOC)){
            ...
            $path = str_replace(" ","-",$titolo);
            $libri .= "<li><img width=\"30\" src=\"$copertina\"><a class=\"ms-2\" href=\"/ReadingNook/books/book.php?titolo=$titolo\">$titolo</a></li>";
    }
    while($line=pg_fetch_array($result2,null,PGSQL_ASSOC)){
            $nome = $line['nome'];
            $cognome = $line['cognome'];
            $path = $nome ."-" . str_replace(" ","",$cognome);
            $autori .= "<li><a href=\"/ReadingNook/author/author.php?nome=$nome&cognome=$cognome\">$nome $cognome</a></li>";
    }
